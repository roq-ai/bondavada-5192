...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`bondavada`}</title>

        <meta
          name="description"
          content="Welcome to Bondavada - Your trusted partner in navigating the complexities of the stock market. Let's make informed investment decisions together."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzdG9jayUyMG1hcmtldHxlbnwwfHx8fDE2OTAwMjY3Mjh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Bondavada - Your trusted partner in navigating the complexities of the stock market. Let's make informed investment decisions together.`}
            </Text>
            <Box
