...
import { getSavedAdviceById } from 'apiSdk/saved-advices';
import { SavedAdviceInterface } from 'interfaces/saved-advice';

function SavedAdviceViewPage() {
              ...
              >
                ...
                {hasAccess('advice', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Advice"
                    text={
                      <Link as={NextLink} href={`/advice/view/${data?.advice?.id}`}>
                        {data?.advice?.content}
                      </Link>
                    }
                  />
